...
const glowDot = keyframes`
  0%, 100% { box-shadow: 0 0 0 3px rgba(1,209,255,0.2), 0 0 12px rgba(1,209,255,0.4); }
  50%       { box-shadow: 0 0 0 5px rgba(1,209,255,0.1), 0 0 24px rgba(1,209,255,0.7); }
`

/* ── Timeline connector accent ────────────────────────────── */
...
const Image = styled.img`
    ...
    ${Card}:hover & {
        box-shadow: 0 0 16px rgba(1, 209, 255, 0.4);
    }
...
const SkillBadge = styled.div`
    ...
    ${Card}:hover & {
        ...
        box-shadow: 0 0 8px rgba(1, 209, 255, 0.25);
    }
`
...
const ExperienceCard = ({ experience }) => {
    return (
        <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2000} glareEnable={true} glareMaxOpacity={0.2} glarePosition="all" glareColor="#01d1ff" style={{ display: 'flex', width: '100%', justifyContent: 'center' }}>
            ...
            <Description>
                ...
                {experience?.skills && (
                    <>
                        <br />
                        <SkillsRow>
                            <b style={{ color: '#8ea8c3', fontSize: 13 }}>Skills:</b>
